        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg ">
            <div class="p-6 text-gray-900 border-b border-gray-300 md:flex md:justify-between md:items-center">
                ...
                <div class="flex justify-center items-center gap-2 mt-5 md:mt-0">
                    ...
                    <a href="" class="text-sm bg-blue-500 hover:bg-blue-600 transition-colors ease-linear duration-300 p-3 rounded text-white">Editar</a>
                    <a href="" class="text-sm bg-red-500 hover:bg-red-600 transition-colors ease-linear duration-300 p-3 rounded text-white">Candidatos</a>
                </div>
            </div>
        </div>
        <div class="mt-5">
